...
start_date_input = st.text_input("Enter a fucking start date", '2010-01-01')
start = datetime.strptime(start_date_input, '%Y-%m-%d')

#my_end_date = '2019-12-31'
end_date_input = st.text_input("Enter a fucking end date", '2019-12-31')
end = datetime.strptime(end_date_input, '%Y-%m-%d')

#Describing Data
st.subheader('data for apple')
user_input = st.text_input("Enter a fucking ticker", "AAPL")
